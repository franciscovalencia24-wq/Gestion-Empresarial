...
with open('infografia_v3.html', 'w', encoding='utf-8') as f:
    f.write(html_content)

hti = Html2Image(size=(2160, 2700))
source_path = 'infografia_megarreforma.png'
hti.screenshot(html_file='infografia_v3.html', save_as=source_path)
...
print(f"Infografía v3 generada y copiada a: {{dest_path}}")
